...
function LoginPage() {
  return (
    <div className="flex w-full h-screen items-center justify-center">
      <img src={bgImage} className="absolute object-center object-cover w-full h-full" />
      <div className="flex h-5/6 w-4/6 bg-black p-10 shadow-2xl bg-opacity-10 backdrop-blur rounded-3xl">
